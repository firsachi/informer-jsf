...
@NamedQueries({
		@NamedQuery(name = "Employee.findDepartmentCompanyDisable", 
				query = "SELECT E FROM Employee E WHERE E.department.id = :department AND E.enterprise.id = :enterprise AND E.remove = :disable  ORDER BY E.post.heft") 
		})
public class Employee implements Serializable {
	...
	public String toString() {
		return "Employee [id=" + id + ", surname=" + surname + ", name=" + name + ", patronymic=" + patronymic
				+ ", phone=" + phone + ", post=" + post + ", department=" + department + ", enterprise=" + enterprise
				+ ", email=" + email + ", room=" + room + ", login=" + login + ", remove=" + remove + "]";
	}
